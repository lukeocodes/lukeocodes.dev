...
export const img = function Img(props: ImagePropsWithOptionalAlt) {
  return (
    <div className="relative mt-8 inline-block overflow-hidden rounded-xl bg-gray-50 ring-1 ring-gray-900/10 dark:bg-gray-900 dark:ring-white/10 [&+*]:mt-8">
      <Image
        alt=""
...
export const article = function Article({
  ...
  return (
    ...
    >
      <div ref={heightRef}>
        <ArticleHeader id={id} from={from} to={to} />
