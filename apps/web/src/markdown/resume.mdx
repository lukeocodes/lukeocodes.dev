...
## Developer Experience Engineer {{ company: "Deepgram", from: '2021-10-01T00:00Z' }}
...
## Engineering Manager {{ company: "Netlify", from: '2021-04-01T00:00Z',  to: '2021-10-01T00:00Z' }}
...
## Developer Advocate {{ company: "Vonage", from: '2019-01-01T00:00Z', to: '2021-04-01T00:00Z' }}
...
## Technical Writer {{ company: "Auth0 by Okta", from: '2017-11-01T00:00Z', to: '2019-01-01T00:00Z' }}
...
## Senior Developer {{ company: "HouseSimple (PurpleBricks)", from: '2015-09-01T00:00Z', to: '2017-11-01T00:00Z' }}
...
## Head of Development {{ company: "Onhotels.com (closed)", from: '2014-03-01T00:00Z', to: '2015-09-01T00:00Z' }}
...
## Senior Developer {{ company: "Absolute Radio", from: '2013-10-01T00:00Z', to: '2014-03-01T00:00Z' }}
...
## Senior Developer {{ company: "Rock IT Group (closed)", from: '2013-02-01T00:00Z', to: '2013-10-01T00:00Z' }}
...
## Web Developer {{ company: "Harbour ATS (3DMarComms)", from: '2012-05-01T00:00Z', to: '2013-02-01T00:00Z' }}
...
## Web Developer {{ company: "Xonadu (X-on)", from: '2011-06-01T00:00Z', to: '2012-05-01T00:00Z' }}
...
## IT Manager {{ company: "Mumford & Wood", from: '2006-06-01T00:00Z', to: '2011-06-01T00:00Z' }}
